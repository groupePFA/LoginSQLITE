package com.example.idetector.beans;
...
public class imagemap {
    ...
    public imagemap(String file_url, String date_captured, gps_location gps_location, String width, String height, List<hotspots> hotspots) {
